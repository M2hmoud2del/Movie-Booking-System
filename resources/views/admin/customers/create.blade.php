...
<div class="dashboard-section">
    ...
    <form>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <input type="text" placeholder="Street address" style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); background: var(--secondary); color: var(--text); margin-bottom: 10px;">
            
            <div style="display: flex; gap: 10px;">
                <input type="text" placeholder="City" style="flex: 1; padding: 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); background: var(--secondary); color: var(--text);">
                <input type="text" placeholder="State/Province" style="flex: 1; padding: 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); background: var(--secondary); color: var(--text);">
                <input type="text" placeholder="ZIP/Postal Code" style="flex: 1; padding: 12px; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); background: var(--secondary); color: var(--text);">
            </div>
        </div>
